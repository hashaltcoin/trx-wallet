...
import (
	...
	"github.com/hashaltcoin/trx-wallet/api"
	...
	"github.com/hashaltcoin/trx-wallet/util"
...
func GetGRPCClient() *GrpcClient {
	...
	client := NewGrpcClient(cfg.NodeURL)
...
func (g *GrpcClient) TransferContract(ownerKey *ecdsa.PrivateKey, Contract string, data []byte) (string, error) {
	...
	transferTransaction := transferTransactionEx.Transaction
	transferTransaction.RawData.FeeLimit = 1000000
